...
## DEC-024 — Historical Management-Report Certification for ST1-045
Status: Accepted

The designated reviewer explicitly approved exactly seven ST1-045 candidates. The controlled lifecycle may certify only those observations under `st1-045-management-report-historical-v1`. Each projected statement retains its source alias, page provenance, report cut-off or issue-date semantics, reviewer, certification actor, timestamp, policy, values, and uncertainty.
