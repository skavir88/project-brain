...
Await the minimum MVP Quality Gate and Certified Data policy decision required to continue beyond the verified synthetic `Ingestion → Structural Validation → Normalization → Deduplication` slice.
